<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="Banking_website.Home" %>
...
<body style="height: 639px">
    <form id="form2" runat="server">
     ...
     <tr>    <th class="auto-style8">&nbsp;<a href="WebForm1.aspx">SAVINGS ACCOUNT </a> </th>
        ...
        <th class="ab"><a href="Login4.aspx">Money transfer&nbsp;</a> </th>
    ...
    <div class="io" style ="background:radial-gradient(yellow ,green); color:white; ">
     <strong style ="color:firebrick"> NET BANKING </strong><br /><br /><br />
       ...
       <i > Already a Customer :</i><a href ="logics.aspx" target ="_blank"><em>Log In</em></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp <br /> <br /><br /><br />&nbsp;<i>New Customer :</i><a href ="signupc.aspx" ><em>Sign Up</em></a>
