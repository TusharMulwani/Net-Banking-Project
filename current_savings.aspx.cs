...
namespace Banking_website
{
    ...
    public partial class current_savings : System.Web.UI.Page
    {
        SqlConnection con;
        SqlCommand cmd;
        SqlDataReader dr;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                con.Open();
                cmd = new SqlCommand("select name , AccountNO  from JOINC where mobile_no = @a", con);
        ...
        protected void Button1_Click1(object sender, EventArgs e)
        {
            ...
            con = new SqlConnection(conStr);
            con.Open();
            cmd = new SqlCommand("select name , Company_name from JOINC where mobile_no = @a", con);
            cmd.Parameters.AddWithValue("@a", l);
            dr = cmd.ExecuteReader();
            while (dr.Read())
            {
                string li = dr["name"].ToString();
                string o = dr["Company_name"].ToString();
                Label3.Text = "Dear  " + li + "  Company  Name Registered In Your Account Is :  " + o;
            }
            dr.Close();
            cmd.ExecuteNonQuery();
            con.Close();
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            con = new SqlConnection(conStr);
            con.Open();
            cmd = new SqlCommand("select name , nominee_name from JOINC where mobile_no = @a", con);
            cmd.Parameters.AddWithValue("@a", l);
            dr = cmd.ExecuteReader();
            while (dr.Read())
            {
                string li = dr["name"].ToString();
                string o = dr["nominee_name"].ToString();
                Label3.Text = "Dear  " + li + " Yours Nominee Name Registered with us Is : Mr" + o;
            }
            dr.Close();
            cmd.ExecuteNonQuery();
            con.Close();
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            con = new SqlConnection(conStr);
            con.Open();
            cmd = new SqlCommand("select name , mobile_no from JOINC where mobile_no = @a", con);
            cmd.Parameters.AddWithValue("@a", l);
            dr = cmd.ExecuteReader();
            while (dr.Read())
            {
                string li = dr["name"].ToString();
                string o = dr["mobile_no"].ToString();
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
            ...
            con = new SqlConnection(conStr);
            con.Open();
            cmd = new SqlCommand("select name , addresses from JOINC where mobile_no = @a", con);
            cmd.Parameters.AddWithValue("@a", l);
            dr = cmd.ExecuteReader();
            while (dr.Read())
            {
        ...
        protected void Button28_Click(object sender, EventArgs e)
        {
            ...
            switch (lo)
            {
                ...
                case "change nominee":
                    ...
                    con = new SqlConnection(conStr);
                    con.Open();
                    cmd = new SqlCommand("  update JOINC set nominee_name = @a where mobile_no = @b", con);
                    cmd.Parameters.AddWithValue("@a", a.Text);
                    cmd.Parameters.AddWithValue("@b", l);
                    cmd.ExecuteNonQuery();
                    con.Close();
                ...
                case "change home address":
                    ...
                    con = new SqlConnection(conStr);
                    con.Open();
                    cmd = new SqlCommand("update JOINC set addresses = @a where mobile_no = @b", con);
                    cmd.Parameters.AddWithValue("@a", a.Text);
                    ...
                    break;
                case "change Firms address":
                    string mri = Request.Cookies["d"].Values["o"];
                    int o12 = int.Parse(mri);
                    con = new SqlConnection(conStr);
                    con.Open();
                    cmd = new SqlCommand("update JOINC set addresses = @a where mobile_no = @b", con);
                    cmd.Parameters.AddWithValue("@a", a.Text);
                    cmd.Parameters.AddWithValue("@b", o12);
                    cmd.ExecuteNonQuery();
                    con.Close();
                    a.Visible = false;
                ...
                case "Change Company Name":
                    string mrik = Request.Cookies["d"].Values["o"];
                    int ly = int.Parse(mrik);
                    con = new SqlConnection(conStr);
                    con.Open();
                    cmd = new SqlCommand("update JOINC set Company_name= @a where mobile_no = @b", con);
                    cmd.Parameters.AddWithValue("@a", a.Text);
                    cmd.Parameters.AddWithValue("@b", ly);
                    cmd.ExecuteNonQuery();
                    con.Close();
                    a.Visible = false;
                ...
                case "Refer":
                    ...
                    cmd = new SqlCommand("select * from friend2 ", con);
                    ...
                    {
                        ds = new DataSet();
                        da = new SqlDataAdapter("Update friend2 set friend_name  = @a  and friend_mob = @b where mob = @c", conStr);
                    ...
                    {
                        ds = new DataSet();
                        da = new SqlDataAdapter("insert into friend2 values(@a , @b , @c)", conStr);
                ...
                case "FeedBack":
                    ...
                    con = new SqlConnection(conStr);
                    con.Open();
                    cmd = new SqlCommand("select * from complaint2", con);
                    ...
                    {
                        ds = new DataSet();
                        da = new SqlDataAdapter("Update complaint2 set feedback  = @a  where mob = @b", conStr);
                    ...
                    {
                        ds = new DataSet();
                        da = new SqlDataAdapter("insert into complaint2 values (@a , @b , @c , @d)", conStr);
                ...
                case "Raise Dispute":
                    ...
                    {
                        ds = new DataSet();
                        da = new SqlDataAdapter("Update complaint2 set dispute  = @a  where mob = @b", conStr);
                    ...
                    else
                    {
                        ...
                        ds = new DataSet();
                        da = new SqlDataAdapter("insert into complaint2 values(@a , @b , @c)", conStr);
                ...
                case "Activate UPI":
                    ...
                    else
                    {
                        ...
                        da.SelectCommand.Parameters.AddWithValue("@f", "current");
                        da.Fill(ds);
                        Label3.Visible = true;
                        Label3.Text = "We Have Raised Your Request. Which Might be enabled by a short period of time ";
                        Button28.Visible = true;
                ...
                case "Activate Mob_Banking":
                    ...
                    if (upo == true)
                    {
                            ...
                            else
                            {
                                ds = new DataSet();
                                da = new SqlDataAdapter("insert into  adi_services  values (@a,@b,@c,@d,@e,@f)", conStr);
                        da.SelectCommand.Parameters.AddWithValue("@a", osil);
                        da.SelectCommand.Parameters.AddWithValue("@b", "N.A.");
                        da.SelectCommand.Parameters.AddWithValue("@c", "yes");
                        da.SelectCommand.Parameters.AddWithValue("@d", "N.A.");
                        da.SelectCommand.Parameters.AddWithValue("@e", "N.A.");
                        da.SelectCommand.Parameters.AddWithValue("@f", "current");
                        da.Fill(ds);
                ...
                case "Delete Payee":
                    ...
                    Button28.Text = "Ok";
                    break;
                case "Change Mobile Numbers":
                    string iu = Request.Cookies["d"].Values["o"];
                    int it = int.Parse(iu);
                    con = new SqlConnection(conStr);
                    con.Open();
                    cmd = new SqlCommand("update JOINC set mobile_no = @a where mobile_no = @b", con);
                    cmd.Parameters.AddWithValue("@a", int.Parse(a.Text));
                    cmd.Parameters.AddWithValue("@b", it);
                    cmd.ExecuteNonQuery();
                    con.Close();
                    a.Visible = false;
        ...
        protected void Button5_Click(object sender, EventArgs e)
        {
            ...
            if (p == true)
            {
                ...
                con.Close();
                ds = new DataSet();
                da = new SqlDataAdapter("select p_name as registered_payee from payee2  where mob_no = @a and actype= @b", conStr);
                da.SelectCommand.Parameters.AddWithValue("@a", l);
                da.SelectCommand.Parameters.AddWithValue("@b", "current");
        ...
        protected void Button9_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.AddWithValue("@a", l);
            cmd.Parameters.AddWithValue("@b", "Business Loan");
            ...
            {
                Label3.Text = "Dear User ,  You Havent  Applied for any type of  " + "Business loan" + " With Us . If you want to raise request then kindly click on Apply Button ,  Else Click On OK ";
                Button28.Text = "OK";
                TM.Visible = true;
                TM.Text = "APPLY";
            }
        ...
        protected void TM_Click(object sender, EventArgs e)
        {
            ...
            switch (l)
            {
                ...
                case "Dont want any change in home address":
                    ...
                    break;
                case "Dont want any change in Firms address":
                ...
                case "Dont want any change in mobile number":
                    ...
                    break;
                case "Dont want any change in mobile numbers":
        ...
        protected void Button8_Click(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand("select * from loanquery6 where MOB_NO = @a and loan_type=@b  ", con);
            cmd.Parameters.AddWithValue("@a", l);
            cmd.Parameters.AddWithValue("@b", "Vehicle Loan");
            ...
            {
                Label3.Text = "Dear User ,  You Havent  Applied for any type of  " + "Vehicle loan" + " With Us . If you want to raise request then kindly click on Apply Button ,  Else Click On OK ";
                Button28.Text = "OK";
                TM.Visible = true;
                TM.Text = "APPLY";
            }
        ...
        protected void Button14_Click(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand("select * from loanquery6 where MOB_NO = @a and loan_type=@b ", con);
            cmd.Parameters.AddWithValue("@a", l);
            cmd.Parameters.AddWithValue("@b", "Property Loan");
            ...
            {
                Label3.Text = "Dear User ,  You Havent  Applied for any type of  " + "property loan" + " With Us . If you want to raise request then kindly click on Apply Button ,  Else Click On OK ";
                Button28.Text = "OK";
                TM.Visible = true;
                TM.Text = "APPLY";
            }
        ...
        protected void Button15_Click(object sender, EventArgs e)
        {
            ...
            while (dr.Read())
            {
                ...
                m1.Values["r "] = k2;
                m1.Values["s"] = mo;
                m1.Values["t"] = "Deposits Against Loan";
                m1.Values["j"] = "current";
        ...
        protected void Button29_Click(object sender, EventArgs e)
        {
            ...
            while (dr.Read())
            {
                ...
                m1.Values["r "] = k2;
                m1.Values["s"] = mo;
                m1.Values["t"] = "Deposits For Interest";
                m1.Values["j"] = "current";
        ...
        {
            Label3.Visible = true;
            Label3.Text = " Kindly Write The Updated  Company Name Here";
            a.Visible = true;
            Button28.Visible = true;
            Button28.Text = "Change Company Name";
            TM.Visible = true;
            TM.Text = "Dont want to Change Company Name";
        ...
        protected void Button17_Click(object sender, EventArgs e)
        {
            ...
            a.Visible = true;
            Button28.Visible = true;
            Button28.Text = "change owner's name";
            TM.Visible = true;
            TM.Text = "Dont want any change in owner's name";
        }
        ...
        protected void Button18_Click(object sender, EventArgs e)
        {
            ...
            a.Visible = true;
            Button28.Visible = true;
            Button28.Text = "change Firms address";
            TM.Visible = true;
            TM.Text = "Dont want any change in Firms address";
        ...
        protected void Button19_Click(object sender, EventArgs e)
        {
            ...
            a.Visible = true;
            Button28.Visible = true;
            Button28.Text = "change mobile numbers";
            TM.Visible = true;
            TM.Text = "Dont want any change in mobile numbers";
        ...
        protected void Button33_Click(object sender, EventArgs e)
        {
            ...
            while (dr.Read())
            {
                ...
                string y = dr["mobile_no"].ToString();
                int lk = int.Parse(y);
                if (k == "Yes" & lk == l)
                {
                    Label3.Visible = true;
        ...
        protected void Button34_Click(object sender, EventArgs e)
        {
            ...
            int p = int.Parse(m);
            ds = new DataSet();
            da = new SqlDataAdapter("select * from moneys2 where mob = @a", conStr);
        ...
        protected void Button37_Click(object sender, EventArgs e)
        {
            ...
            con = new SqlConnection(conStr);
            con.Open();
            cmd = new SqlCommand("select sum(amount) as total from moneys2 where mob = @a and actype = @v", con);
            cmd.Parameters.AddWithValue("@a", l);
        ...
        {
            Response.Write("<script>alert('thanks for logging in we are directing you to the login page '); window.location='Current_login.aspx'</script>");
